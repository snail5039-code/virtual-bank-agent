...
from agents.account.nodes import (account_history_node, account_query_node,
                                  account_router_node, account_todo_node, route_by_task)
...
builder.add_conditional_edges("account_router", route_by_task, ["account_query", "account_history", "transfer", "account_todo"])
